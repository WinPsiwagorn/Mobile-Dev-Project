...
import { User, Bell, Shield, HelpCircle, ChevronRight, Crown, LogOut } from "lucide-react-native"
    ...
    const refreshUserData = async () => {
      if (user?.uid) {
        try {
          ...
          if (userDoc.exists()) {
            // The AuthContext will automatically update with the latest data
            // when the Firestore document is updated
    ...
    <ScreenLayout backgroundColor={colors.background}>
      ...
      >
        <View style={styles.profileHeader}>
          ...
          <Text style={[styles.userName, { color: colors.surface }]}>{user?.displayName || "John Williams"}</Text>
