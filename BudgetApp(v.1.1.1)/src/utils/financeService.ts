...
class FinanceService {
  ...
  async addAccount(account: Omit<Account, "id">): Promise<Account> {
    ...
    const newAccount = {
      ...account,
      id: generateId(),
      balance: account.type === "general" ? account.currentBalance : 0,
      currentBalance: account.type === "general" ? account.currentBalance : 0,
      goalBalance: account.type === "savings" ? account.goalBalance : undefined,
    }
