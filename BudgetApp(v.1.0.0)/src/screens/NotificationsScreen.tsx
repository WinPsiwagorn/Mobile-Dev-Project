          ...
          {notificationItems.map((item) => (
            <View key={item.id} style={[styles.settingItem, { borderBottomColor: colors.border }]}>
              ...
              <Switch
                ...
                onValueChange={() => toggleSetting(item.id as keyof typeof notificationSettings)}
                trackColor={{ 
                  false: "rgba(255, 255, 255, 0.3)",
                  true: `${item.color}80`
                }}
                thumbColor={notificationSettings[item.id as keyof typeof notificationSettings] ? item.color : "#FFFFFF"}
