...
import { View, Text, StyleSheet, TouchableOpacity, ScrollView, Dimensions, Modal, TextInput, RefreshControl } from "react-native"
...
export default function AccountDetailsScreen() {
  ...
  const { accounts, transactions, deleteAccount, updateAccount, getAccounts, getTransactions } = useFinance()
  ...
  const onRefresh = useCallback(async () => {
    setRefreshing(true)
    try {
      await Promise.all([getAccounts(), getTransactions()])
    } catch (error) {
