...
export default function ReportsScreen() {
  ...
  const { transactions, accounts, getAccounts, getTransactions } = useFinance()
  ...
  // Update calculations when transactions or accounts change
  useEffect(() => {
    // Calculate total balance from all accounts
    const newTotalBalance = accounts.reduce((sum, account) => sum + account.balance, 0)
    ...
    const newTotalInvestments = savingsAndInvestmentAccounts
