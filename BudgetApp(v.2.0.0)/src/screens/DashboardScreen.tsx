...
import { View, Text, StyleSheet, TouchableOpacity, Dimensions, Animated, ScrollView, Platform, RefreshControl } from "react-native"
...
export default function DashboardScreen() {
  ...
  const { accounts, transactions, isLoading, getAccounts, getTransactions } = useFinance()
      ...
      >
        <LinearGradient colors={["#FFB23F", "#FF8F3F"] as const} style={styles.headerGradient}>
          ...
          >
            ...
            <Text style={styles.welcomeText}>Welcome back, {userData?.displayName || "User"}</Text>
