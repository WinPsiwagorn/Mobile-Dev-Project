...
const RETENTION_PERIODS = {
  ...
  [STORAGE_KEYS.TRANSACTIONS]: 365 * 24 * 60 * 60 * 1000, // 1 year
  [STORAGE_KEYS.NOTIFICATIONS]: 30 * 24 * 60 * 60 * 1000, // 30 days
  [STORAGE_KEYS.SENT_NOTIFICATIONS]: 30 * 24 * 60 * 60 * 1000, // 30 days
} as const;
