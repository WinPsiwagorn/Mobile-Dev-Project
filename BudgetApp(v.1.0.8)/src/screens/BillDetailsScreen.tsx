...
export default function BillDetailsScreen() {
  ...
  const { bills, accounts, updateBill, updateAccount, addTransaction, deleteBill } = useFinance()
        ...
        <View style={[styles.card, { backgroundColor: colors.glass.background }]}>
          ...
          <View style={styles.detailRow}>
            ...
            <View style={styles.detailItem}>
              ...
              <Text style={[styles.detailLabel, { color: colors.textSecondary }]}>Payment Account</Text>
              <Text style={[styles.detailValue, { color: colors.text }]}>
                {bill.paymentAccountId ? accounts.find(acc => acc.id === bill.paymentAccountId)?.name : "Not specified"}
              </Text>
            </View>
          </View>
          <View style={styles.detailRow}>
