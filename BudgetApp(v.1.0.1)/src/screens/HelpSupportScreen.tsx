    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <ScrollView style={styles.content}>
            ...
            >
              <View style={styles.helpItemLeft}>
                ...
                <View style={styles.helpItemContent}>
                  ...
                  <Text style={[styles.helpItemDescription, { color: colors.textSecondary }]}>{item.description}</Text>
                </View>
              </View>
        ...
        <View style={[styles.supportCard, { backgroundColor: colors.surface }]}>
          <Text style={[styles.supportTitle, { color: colors.text }]}>24/7 Premium Support</Text>
          ...
          >
            ...
            <Text style={[styles.supportButtonText, { color: colors.surface }]}>Start Chat</Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
    </View>
