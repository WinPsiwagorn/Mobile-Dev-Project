...
import { ArrowLeft, Shield, Fingerprint, Lock, Eye, Key, AlertTriangle } from "lucide-react-native"
    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      >
        <View style={styles.header}>
          ...
          <Text style={[styles.headerTitle, { color: colors.surface }]}>Security</Text>
      ...
      <ScrollView style={styles.content}>
        <View style={[styles.card, { backgroundColor: colors.surface }]}>
          {securityItems.map((item) => (
            <View key={item.id} style={[styles.settingItem, { borderBottomColor: colors.border }]}>
              ...
              <Switch
                ...
                onValueChange={() => toggleSetting(item.id as keyof typeof securitySettings)}
                trackColor={{ 
                  false: "rgba(255, 255, 255, 0.3)",
                  true: `${item.color}80`
                }}
                thumbColor={securitySettings[item.id as keyof typeof securitySettings] ? item.color : "#FFFFFF"}
