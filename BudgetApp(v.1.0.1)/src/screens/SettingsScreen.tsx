      ...
      >
        ...
        <View style={[styles.profileCard, globalStyles.glass]}>
          ...
          <View style={styles.profileInfo}>
            <Text style={[styles.profileName, { color: colors.surface }]}>John Doe</Text>
            <Text style={[styles.profileEmail, { color: colors.surface }]}>john.doe@example.com</Text>
          </View>
          <TouchableOpacity style={[styles.editButton, { backgroundColor: colors.glass.background }]}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        {settingSections.map((section) => (
          <View key={section.title} style={styles.section}>
            ...
            <View style={styles.sectionContent}>{section.data.map(renderSettingItem)}</View>
          </View>
        ))}
      </ScrollView>
    </View>
