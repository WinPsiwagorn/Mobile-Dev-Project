        ...
        <View style={styles.summaryCard}>
          ...
          <View style={styles.summaryRow}>
            ...
            <View style={styles.summaryItem}>
              ...
              <Text style={styles.summaryValue}>{categories.filter((c) => c.type === "expense").length}</Text>
            </View>
            <View style={styles.summaryItem}>
              <Text style={styles.summaryLabel}>Income Categories</Text>
              <Text style={styles.summaryValue}>{categories.filter((c) => c.type === "income").length}</Text>
            </View>
          </View>
        </View>
            ...
            <View key={category.id} style={styles.categoryCard}>
              <View style={styles.categoryHeader}>
                ...
                <View style={styles.categoryInfo}>
                  ...
                  <Text style={styles.categoryBudget}>Budget: ${category.budget.toLocaleString()}</Text>
                </View>
                <View style={styles.categoryAmount}>
                  <Text style={styles.categorySpent}>${category.spent.toLocaleString()}</Text>
          ...
          .map((category) => (
            <View key={category.id} style={styles.categoryCard}>
              <View style={styles.categoryHeader}>
                ...
                <View style={styles.categoryInfo}>
                  <Text style={styles.categoryName}>{category.name}</Text>
                  <Text style={styles.categoryBudget}>Expected: ${category.budget.toLocaleString()}</Text>
                </View>
                <View style={styles.categoryAmount}>
                  <Text style={styles.categorySpent}>${category.spent.toLocaleString()}</Text>
                  <Text style={styles.categoryRemaining}>
        ...
        {isAddingCategory ? (
          <View style={styles.addCategoryForm}>
            ...
            <View style={styles.typeSelector}>
              <TouchableOpacity
                style={[styles.typeButton, newCategory.type === "expense" && styles.typeButtonActive]}
                onPress={() => setNewCategory({ ...newCategory, type: "expense" })}
              >
                <Text style={[styles.typeButtonText, newCategory.type === "expense" && styles.typeButtonTextActive]}>
                  Expense
                </Text>
              </TouchableOpacity>
              <TouchableOpacity
                style={[styles.typeButton, newCategory.type === "income" && styles.typeButtonActive]}
                onPress={() => setNewCategory({ ...newCategory, type: "income" })}
              >
                <Text style={[styles.typeButtonText, newCategory.type === "income" && styles.typeButtonTextActive]}>
                  Income
                </Text>
              </TouchableOpacity>
            </View>
          ...
          <TouchableOpacity style={styles.addButton} onPress={() => setIsAddingCategory(true)}>
